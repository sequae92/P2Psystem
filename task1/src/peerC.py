...
for i in c.active_peers:
    ...
    if i.hostname == "server01":
        ...
        print "RFC Query from PeerC to PeerA complete."
        ...
        for index in indexlist:
            ...
            if rfc_count < 50:
                ...
                print "GetRFC from PeerC to PeerA complete." 
            else:
                print "All 50 RFCs downloaded."
            rfc_count += 1
        cumulative_time = sum(rfc_download_times.values())
        print "Times for each RFC download in PeerC:", rfc_download_times
        print "Cumulative download time for all RFCs in PeerC is {}".format(cumulative_time)
